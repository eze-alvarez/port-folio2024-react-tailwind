export default function Error() {
  return (
    <div className="pt-14 px-10 flex flex-col mx-auto h-screen  w-ful items-center justify-center gap-5
    sm:h-[calc(100vh-300px)] sm:gap-16 sm:max-w-[90vw]
    sm:landscape:flex-row sm:landscape:h-screen sm:landscape:gap-2
    lg:landscape:h-[calc(100vh-224px)]
    
    ">
      <div className="w-full flex flex-col items-center border-4 border-yellow1 p-4
      landscape:p-2
      md:landscape:p-4
      lg:landscape:p-6
      ...
      ">
        ...
        md:landscape:text-7xl
        ">
          404
        </p>
        <p className="text-center text-3xl 
        
        font-bold tracking-wider text-gray-300 mt-2
        sm:landscape:text-3xl lg:landscape:text-4xl">
          Page Not Found
        </p>
        <p className="text-center text-lg md:text-xl lg:text-2xl text-gray-500 my-7 sm:my-4 lg:my-7 xl:my-10
        landscape:text-sm">
      ...
      <div className="w-3/4  lg:h-full flex lg:items-end justify-center p-4 ">
        <svg
