        ...
        <div className="w-full max-w-6xl rounded-md bg-white shadow-xl p-10  mx-auto text-gray-800 relative md:text-left lg:h-96 xl:h-[30rem] lg:flex lg:items-center 2xl:max-w-[1400px] 2xl:h-[35rem]">
          <div className="md:flex items-center -mx-10 ">
            <div className="h-[calc(10rem*1.618)] w-40 mb-10 mx-auto rounded-md flex justify-center items-center">
              <div className="relative h-[100%] w-full rounded-[2rem] shadow-3xl hover:shadow-hov cursor-pointer">
            ...
            <div className="w-full md:w-2/3 lg:w-[80%] px-10 lg:pl-2">
              ...
              <section className="flex flex-col lg:flex-row lg:gap-x-8 ">
                ...
                <div className="lg:w-1/2 flex flex-col border-2 border-yellow1 p-4 lg:pb-2">
                  <h2 className="font-bold uppercase text-xl mb-5 lg:text-center">
                    Tecnologias
                  </h2>
                  <ul className="text-sm grid justify-center mb-1 sm:grid-cols-2  gap-x-3 italic">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-block self-end mt-7 mr-5"
                  >
